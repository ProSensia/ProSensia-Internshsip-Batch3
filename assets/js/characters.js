...
const PS_CHARS = {
  ac: {
    ...
    lines: {
      ...
      waitUnlock:    t  => `Hey! Tasks unlock at ${String(_unlockHour()).padStart(2,'0')}:${String(_unlockMin()).padStart(2,'0')} sharp. It's ${t} right now — mark your attendance while we wait! ❄️`,
  ...
  geyser: {
    ...
    lines: {
      ...
      waitUnlock:    t  => `Good morning! Tasks will be ready at ${String(_unlockHour()).padStart(2,'0')}:${String(_unlockMin()).padStart(2,'0')}. It's ${t} right now — mark attendance first! 😊`,
