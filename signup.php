...
<link rel="icon" type="image/png" href="<?= base_url('assets/img/prosensia-logo.png') ?>">
...
<div class="signup-wrap">
  <div class="wizard glass-strong card-pad">
    <div class="text-center mb-3"><img src="<?= base_url('assets/img/prosensia-logo.png') ?>" alt="ProSensia" style="max-width:160px"></div>
